...
python3 src/embed_textual_data.py --overwrite --embedding_model 'jinaai/jina-embeddings-v2-base-en'
python3 src/embed_textual_data.py --overwrite --embedding_model 'thenlper/gte-large'
python3 src/generate_model_embeddings.py --overwrite --embedding_model 'jinaai/jina-embeddings-v2-base-en'
